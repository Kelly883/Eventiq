---
name: delivery
description: Use this reference for Standard, Deep, and Full Project Audit work. Read it for Quick work only when elevated security, permission, persistence, integration, migration, or major UI/UX risk applies.
license: MIT
metadata:
