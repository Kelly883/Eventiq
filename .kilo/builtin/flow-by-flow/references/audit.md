---
name: audit
description: Use this mode when the product already exists. The goal is to discover reality, prove each flow, repair defects, and produce the same portable foundation used for greenfield work.
license: MIT
metadata:
