---
name: foundation
description: This workflow creates the product foundation. In End to end mode, validation is a checkpoint, not the finish line. Continue into build.md without waiting for a second request.
license: MIT
metadata:
