...
// (backend/app/Http/Resources/EventPublicResource.php): title, start_datetime,
// venue_name / city, category, banner_image_url, ticket_price, tickets_remaining.
// Also tolerates the legacy camelCase fields older components still reference so
// this card is safe to reuse regardless of which host shapes the data.
const fallbackImage =
