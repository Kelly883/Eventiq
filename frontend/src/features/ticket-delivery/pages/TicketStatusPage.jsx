          ...
          <div className="md:col-span-5 space-y-6" id="delivery-status-section">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
              ...
              <p className="text-xs text-slate-500 mb-6">
                Real-time connection status with the <strong>bam-ticketing-sdk</strong> dispatcher.
              </p>
            ...
            <div className="bg-slate-850 bg-slate-900 rounded-2xl p-6 text-slate-100 shadow-sm border border-slate-800">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                QR codes are refreshed dynamically and signed using BAM-ticketing cryptographic protocols. Webhook callbacks validate transactions with private backend hashes before status synchronization.
              </p>
            </div>
          </div>
