...
class TransactionResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'fees' => $this->fees !== null ? (string) $this->fees : null,
            'netAmount' => $this->net_amount !== null ? (string) $this->net_amount : null,
            'refundedAmount' => $this->refunded_amount !== null ? (string) $this->refunded_amount : null,
