...
class AdminTicketController extends Controller
{
    ...
    {
        $query = Ticket::query()
            ->select(['id', 'ticket_id', 'attendee_name', 'attendee_email', 'tier', 'status', 'checked_in', 'checked_in_at', 'event_id', 'created_at'])
    ...
    {
        $ticket = Ticket::select(['id', 'ticket_id', 'attendee_name', 'attendee_email', 'tier', 'status', 'checked_in', 'checked_in_at', 'checked_in_by', 'event_id', 'created_at'])
            ->with(['event:id,title', 'user:id,name,email'])
            ->findOrFail($id);
