...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('throttle:30,1')->get('/me/tickets/for-offline-sync', [App\Features\OfflineSync\Controllers\OfflineSyncController::class, 'getTicketsForOfflineSync']);
